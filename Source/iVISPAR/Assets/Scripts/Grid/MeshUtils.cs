...
public static class MeshUtils {
	...
	public static void CreateEmptyMeshArrays(int quadCount, out Vector3[] vertices,out Color[] vertexColors, out Vector2[] uvs, out int[] triangles) {
		vertices = new Vector3[4 * quadCount];
		vertexColors = new Color[4 * quadCount];
		uvs = new Vector2[4 * quadCount];
		triangles = new int[6 * quadCount];
    }
    public static void CreateEmptyMeshArrays(int quadCount, out Vector3[] vertices,out Color32[] vertexColors, out Vector2[] uvs, out int[] triangles) {
		vertices = new Vector3[4 * quadCount];
		vertexColors = new Color32[4 * quadCount];
		uvs = new Vector2[4 * quadCount];
		triangles = new int[6 * quadCount];
    }
 ...
 public static void AddToMeshArrays(Vector3[] vertices, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float rot, Vector3 baseSize, Vector2 uv00, Vector2 uv11) {
    ...
    public static void AddToMeshArrays(Vector3[] vertices, Color[] VertexColors, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float rot, Vector3 baseSize, Vector2 uv00, Vector2 uv11, Color vertexColor) {
		//Relocate vertices
		int vIndex = index*4;
		int vIndex0 = vIndex;
		int vIndex1 = vIndex+1;
		...
		VertexColors[vIndex0] = vertexColor;
		VertexColors[vIndex1] = vertexColor;
		VertexColors[vIndex2] = vertexColor;
		VertexColors[vIndex3] = vertexColor;
		//Relocate UVs
		uvs[vIndex0] = new Vector2(uv00.x, uv11.y);
		uvs[vIndex1] = new Vector2(uv00.x, uv00.y);
		uvs[vIndex2] = new Vector2(uv11.x, uv00.y);
	...
	public static void AddToMeshArrays(Vector3[] vertices, Color32[] VertexColors, Vector2[] uvs, int[] triangles, int index, Vector3 pos, float rot, Vector3 baseSize, Vector2 uv00, Vector2 uv11, Color32 vertexColor) {
		//Relocate vertices
		int vIndex = index*4;
		int vIndex0 = vIndex;
		int vIndex1 = vIndex+1;
