...
def plot_heat_map_episode_level_average(experiment_id, compiled_csv="episode_outcomes_evaluation.csv",
    ...
    for metric in metrics:
        ...
        sns.heatmap(heatmap_data, annot=True, fmt=".2f",
                    cmap='viridis_r', cbar=True)# if metric in ['min_path_length', 'spl_value'] else 'magma', cbar=True) #don't like magma
